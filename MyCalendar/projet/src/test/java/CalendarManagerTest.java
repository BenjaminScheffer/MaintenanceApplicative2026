...
class CalendarManagerTest {
    ...
    void testAjoutEventReunion() {
        ...
        calendarManager.ajouterEventReunion("1","test","Moi",
    ...
    void testAjoutEventRdv() {
        CalendarManager calendarManager = new CalendarManager();
        calendarManager.ajouterEventRendezVousPersonnel("1","test","Moi",
                LocalDateTime.of(2000, 7, 12, 12, 0) // 12/07/2000
                ,30);
    ...
    void testAjoutEventPeriodique() {
        CalendarManager calendarManager = new CalendarManager();
        calendarManager.ajouterEventPeriodique("1","test","Moi",
                LocalDateTime.of(2000, 7, 12, 12, 0) // 12/07/2000
                ,90,30);
    ...
    void testEventsDansPeriode() {
        ...
        calendarManager.ajouterEventRendezVousPersonnel("2","repas nouvelle année","Moi",
                LocalDateTime.of(2010, 1, 1, 12, 0), // 01/01/2010
                30);

        calendarManager.ajouterEventPeriodique("3","Musculation","Moi",
                LocalDateTime.of(2010, 1, 1, 14, 0) // 01/01/2010
                ,90,30);

        calendarManager.ajouterEventPeriodique("4","Escalade","Moi",
                LocalDateTime.of(2008, 1, 1, 14, 0) // 01/01/2008
                ,90,30);

        calendarManager.ajouterEventRendezVousPersonnel("5","Anniversaire LuLu","Moi",
    ...
    void testConflit() {
        ...
        calendarManager.ajouterEventRendezVousPersonnel("6","Anniversaire Lolo","Moi",
                LocalDateTime.of(2020, 11, 7, 12, 0) // 07/11/2020 12h00 -> 12h30
                ,30);

        calendarManager.ajouterEventRendezVousPersonnel("7","Mariage Paul","Moi",
